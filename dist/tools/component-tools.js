...
class ComponentTools {
    ...
    async removeComponent(nodeUuid, componentType) {
        return new Promise(async (resolve) => {
            ...
            const availableTypes = allComponentsInfo.data.components.map((c) => c.type);
            ...
            try {
                ...
                const stillExists = afterRemoveInfo.success && ((_c = (_b = afterRemoveInfo.data) === null || _b === void 0 ? void 0 : _b.components) === null || _c === void 0 ? void 0 : _c.some((comp) => comp.type === resolvedType));
                if (stillExists) {
    ...
    async getComponentInfo(nodeUuid, componentType) {
        return new Promise((resolve) => {
            // 优先尝试直接使用 Editor API 查询节点信息
            Editor.Message.request('scene', 'query-node', nodeUuid).then(async (nodeData) => {
                if (nodeData && nodeData.__comps__) {
                    const typeOf = (comp) => comp.__type__ || comp.cid || comp.type;
                    let component = nodeData.__comps__.find((comp) => typeOf(comp) === componentType);
                    // Fall back to class-name -> cid resolution if the direct match failed.
                    if (!component) {
                        const availableTypes = nodeData.__comps__.map((c) => typeOf(c));
                        const resolvedType = await this.resolveComponentType(nodeUuid, componentType, availableTypes);
                        if (resolvedType) {
                            component = nodeData.__comps__.find((comp) => typeOf(comp) === resolvedType);
                        }
                    }
                    if (component) {
                        resolve({
     ...
     */
    async resolveComponentType(nodeUuid, componentType, availableTypes) {
        var _a;
        ...
        try {
            ...
            if (result && result.success && ((_a = result.data) === null || _a === void 0 ? void 0 : _a.cid)) {
    ...
    async setComponentProperty(args) {
        ...
        return new Promise(async (resolve) => {
            ...
            try {
                ...
                if (resolvedType) {
                    targetComponent = allComponents.find((comp) => comp.type === resolvedType) || null;
                }
                if (!targetComponent) {
                ...
                const effectiveComponentType = resolvedType;
                // Step 3: 自动检测和转换属性值
                let propertyInfo;
                try {
                    ...
                    case 'size': {
                        ...
                        if (typeof sizeObj === 'string') {
                            try {
                                ...
                                throw new Error(`Size value must be an object like {"width":54,"height":54}. ` +
                        ...
                        if (sizeObj && typeof sizeObj === 'object') {
                            ...
                            if (!Number.isFinite(width) || !Number.isFinite(height)) {
                                throw new Error(`Size value must contain numeric width and height (or x and y). ` +
                                    `Received ${JSON.stringify(value)}.`);
                            }
                            processedValue = { width, height };
                        }
                        else {
                            throw new Error(`Size value must be an object with width and height properties, e.g. {"width":54,"height":54}. ` +
                                `Received ${JSON.stringify(value)}.`);
                        }
                        break;
                    }
...
//# sourceMappingURL=data:application/json;base64,